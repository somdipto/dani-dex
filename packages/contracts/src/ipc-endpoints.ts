...
export const IPC_ENDPOINTS = {
  ...
  auth: {
    ...
    getSignInOptions: request(IPC_CHANNELS.authGetSignInOptions),
    signInWithProvider: request(IPC_CHANNELS.authSignInWithProvider),
    cancelProviderSignIn: request(IPC_CHANNELS.authCancelProviderSignIn),
