export const IPC_CHANNELS = {
  ...
  voiceSetRealtimeApiKey: "voice:set-realtime-api-key",
  voiceClearRealtimeApiKey: "voice:clear-realtime-api-key",
  voiceGetRealtimeApiKeyStatus: "voice:get-realtime-api-key-status",
  ...
  authGetSignInOptions: "auth:get-sign-in-options",
  authSignInWithProvider: "auth:sign-in-with-provider",
  authCancelProviderSignIn: "auth:cancel-provider-sign-in",
  ...
  agentGetOperatingInstructions: "agent:get-operating-instructions",
  agentUpdateOperatingInstructions: "agent:update-operating-instructions",
  agentRefreshOperatingInstructions: "agent:refresh-operating-instructions",
