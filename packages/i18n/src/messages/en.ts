...
export const en = {
  ...
  "settings.voiceKey.title": "Voice calls",
  "settings.voiceKey.description":
    "Voice calls use your own OpenAI API key. It stays encrypted on this device, and each call gets a short-lived key from OpenAI.",
  "settings.voiceKey.rowTitle": "OpenAI API key",
  "settings.voiceKey.missing": "No key saved. Add one to start voice calls.",
  "settings.voiceKey.saved": "Key saved. Paste a new one to replace it.",
  "settings.voiceKey.unreadable": "The saved key can't be read. Paste it again, or remove it.",
  "settings.voiceKey.placeholder": "sk-...",
  "settings.voiceKey.save": "Save",
  "settings.voiceKey.remove": "Remove",
  "settings.voiceKey.readFailed": "Couldn't read the saved key.",
