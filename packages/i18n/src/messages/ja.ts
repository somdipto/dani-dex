...
export const ja = {
  ...
  "settings.providers.title": "AI の選択肢",
  ...
  "settings.voiceKey.title": "音声通話",
  "settings.voiceKey.description":
    "音声通話にはご自身の OpenAI API キーを使います。キーはこのデバイスに暗号化して保存され、通話ごとに OpenAI から短期キーが発行されます。",
  "settings.voiceKey.rowTitle": "OpenAI API キー",
  "settings.voiceKey.missing": "キーが保存されていません。音声通話を始めるには追加してください。",
  "settings.voiceKey.saved": "キーは保存済みです。置き換えるには新しいキーを貼り付けてください。",
  "settings.voiceKey.unreadable": "保存済みのキーを読み取れません。もう一度貼り付けるか、削除してください。",
  "settings.voiceKey.placeholder": "sk-...",
  "settings.voiceKey.save": "保存",
  "settings.voiceKey.remove": "削除",
  "settings.voiceKey.readFailed": "保存済みのキーを読み取れませんでした。",
  "settings.voiceKey.saveFailed": "キーを保存できませんでした。もう一度お試しください。",
  "settings.voiceKey.removeFailed": "キーを削除できませんでした。もう一度お試しください。",
  ...
  "provider.refreshLabel": "AI の選択肢を再確認",
  "provider.refreshingLabel": "AI の選択肢を確認中",
